    ...
    <>
      ...
      >
        ...
        <div className="flex items-center justify-end gap-2 sm:gap-3.5 shrink-0">
          {/* System Health */}
          <div className="hidden 3xl:flex items-center gap-2 px-3 py-1.5 rounded-full bg-emerald-50/80 text-emerald-700 text-[11px] font-bold tracking-tight border border-emerald-100/50">
            <span className="w-1.5 h-1.5 rounded-full bg-emerald-500 animate-pulse shadow-[0_0_6px_rgba(16,185,129,0.5)]" />
            System Healthy
          </div>

          <div className="hidden xl:flex items-center gap-2 sm:gap-3.5 shrink-0">
            <ConnectionIndicator />
            <LanguageSelector />
          </div>
          ...
          {/* User Profile */}
          <div className="flex items-center gap-2 sm:gap-3 pl-2 sm:pl-4 border-l border-slate-200/80 h-8 shrink-0">
            ...
            <button 
              ...
              className="ml-1 sm:ml-2 flex items-center gap-1.5 px-3 py-1.5 bg-slate-100/80 text-slate-600 hover:text-rose-600 hover:bg-rose-50 rounded-full transition-colors active:scale-95 text-xs font-semibold shadow-sm border border-slate-200/60 shrink-0"
              title="Sign Out"
            >
